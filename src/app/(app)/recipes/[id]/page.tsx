...
import { ChevronLeft, Minus, Plus, Flag, CheckCircle2 } from "lucide-react";
...
import { getRecipe, getOpenFlagsForRecipe, raiseFlag, resolveFlag } from "@/lib/repo/recipes";
...
function RecipeDetailContent({ id }: { id: string }) {
  ...
  return (
    <div className="pb-10">
      ...
      {/* Portion scaler */}
      <Card className="mx-4 md:mx-8 mt-4 flex items-center justify-between">
        <div>

import type { MenuItem, MenuOption, PrintedMaterial } from "@/lib/types";
...
/**
 * How spicy, asked per person.
 *
 * Required, because "did they say spicy?" after the plate has gone out is not
 * a recoverable question — and with an allergy-adjacent ingredient it is worse
 * than untidy. No price difference; it is a cooking instruction.
 */
const SPICE_LEVEL: MenuOption = {
  id: "opt_spice",
  label: { en: "Spice level", vi: "Độ cay" },
  required: true,
  choices: [
    { id: "spice_none", label: { en: "Non-spicy", vi: "Không cay" }, priceDeltaVnd: 0 },
    { id: "spice_normal", label: { en: "Spicy", vi: "Cay" }, priceDeltaVnd: 0 },
    { id: "spice_extra", label: { en: "Extra spicy", vi: "Rất cay" }, priceDeltaVnd: 0 },
  ],
};

/**
 * Alcoholic or not, on every cocktail.
 *
 * One row per drink rather than one row per drink per version: fourteen
 * near-identical rows to scroll past mid-service is how a waiter taps the
 * wrong one. The delta is what the standalone Mocktail item used to be —
 * 85,000 against a 130,000 cocktail — so it was removed rather than left to
 * drift out of step with the drink it mirrors.
 */
const COCKTAIL_OR_MOCKTAIL: MenuOption = {
  id: "opt_alcohol",
  label: { en: "Cocktail or mocktail", vi: "Có cồn hay không" },
  required: true,
  choices: [
    { id: "with_alcohol", label: { en: "Cocktail", vi: "Cocktail" }, priceDeltaVnd: 0 },
    { id: "no_alcohol", label: { en: "Mocktail", vi: "Mocktail" }, priceDeltaVnd: -45000 },
  ],
};

export const SEED_MENU_ITEMS: MenuItem[] = [
  { id: "mi_jerk_chicken", name: { en: "Jerk Chicken", vi: "Gà Jerk" }, category: "main", recipeId: "rc_jerk_chicken", pricesVnd: { dine_in: 210000, delivery: 210000, lunch_box: null }, active: true, updatedAt, options: [SPICE_LEVEL] },
  { id: "mi_lunch_box", name: { en: "Jerk Lunch Box", vi: "Cơm Hộp Trưa Gà Jerk" }, category: "main", recipeId: "rc_jerk_chicken", pricesVnd: { dine_in: null, delivery: null, lunch_box: 170000 }, options: [SPICE_LEVEL], priceNote: { en: "Takeaway only, 12pm–3pm · Served with 2 sides, extra sides +35,000", vi: "Chỉ mang về, 12:00–15:00 · Kèm 2 món phụ, thêm món phụ +35.000" }, active: true, updatedAt },
  ...
  { id: "mi_rum_punch", name: { en: "Classic Rum Punch", vi: "Rum Punch Cổ Điển" }, category: "cocktail", recipeId: "rc_rum_punch", pricesVnd: { dine_in: 130000, delivery: 130000, lunch_box: null }, active: true, updatedAt , options: [COCKTAIL_OR_MOCKTAIL] },
  { id: "mi_passionfruit_colada", name: { en: "Passionfruit Colada", vi: "Passionfruit Colada" }, category: "cocktail", recipeId: "rc_passionfruit_colada", pricesVnd: { dine_in: 130000, delivery: 130000, lunch_box: null }, active: true, updatedAt , options: [COCKTAIL_OR_MOCKTAIL] },
  { id: "mi_ginger_fizz", name: { en: "Jerk & Chill Ginger Fizz", vi: "Jerk & Chill Ginger Fizz" }, category: "cocktail", recipeId: "rc_ginger_fizz", pricesVnd: { dine_in: 130000, delivery: 130000, lunch_box: null }, active: true, updatedAt , options: [COCKTAIL_OR_MOCKTAIL] },
  { id: "mi_pineapple_daiquiri", name: { en: "Spiced Pineapple Daiquiri", vi: "Spiced Pineapple Daiquiri" }, category: "cocktail", recipeId: "rc_pineapple_daiquiri", pricesVnd: { dine_in: 130000, delivery: 130000, lunch_box: null }, active: true, updatedAt , options: [COCKTAIL_OR_MOCKTAIL] },
  ...
  // One row per drink. "Soft Drinks (Coke / Sprite / Fanta)" made the waiter
  // remember which was ordered, and told the bar nothing.
  { id: "mi_coke", name: { en: "Coca-Cola", vi: "Coca-Cola" }, category: "beverage", pricesVnd: { dine_in: 25000, delivery: 25000, lunch_box: null }, active: true, updatedAt },
  { id: "mi_sprite", name: { en: "Sprite", vi: "Sprite" }, category: "beverage", pricesVnd: { dine_in: 25000, delivery: 25000, lunch_box: null }, active: true, updatedAt },
  { id: "mi_fanta", name: { en: "Fanta", vi: "Fanta" }, category: "beverage", pricesVnd: { dine_in: 25000, delivery: 25000, lunch_box: null }, active: true, updatedAt },

...
export const SEED_MENU_ITEMS: MenuItem[] = [
  ...
  { id: "mi_passionfruit_colada", name: { en: "Passionfruit Colada", vi: "Passionfruit Colada" }, category: "cocktail", pricesVnd: { dine_in: 130000, delivery: 130000, lunch_box: null }, active: true, updatedAt },
  { id: "mi_ginger_fizz", name: { en: "Jerk & Chill Ginger Fizz", vi: "Jerk & Chill Ginger Fizz" }, category: "cocktail", pricesVnd: { dine_in: 130000, delivery: 130000, lunch_box: null }, active: true, updatedAt },
  { id: "mi_pineapple_daiquiri", name: { en: "Spiced Pineapple Daiquiri", vi: "Spiced Pineapple Daiquiri" }, category: "cocktail", pricesVnd: { dine_in: 130000, delivery: 130000, lunch_box: null }, active: true, updatedAt },

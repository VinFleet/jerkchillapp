...
export const SEED_LICENSES: License[] = [
  ...
  { id: "lic_pccc", name: { en: "Fire Safety & Insurance Certificates", vi: "Giấy PCCC & Bảo Hiểm" }, expiryDate: null, renewalLeadDays: 60, notes: { en: "Confirm status and renewal cycle with Owner", vi: "Cần xác nhận tình trạng và chu kỳ gia hạn với Chủ" } },
